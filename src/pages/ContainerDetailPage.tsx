...
export default function ContainerDetailPage() {
  ...
  const container = useMemo(() => getContainerData(containerId || "0"), [containerId]);
  ...
  return (
    <div>
      <motion.div
        ...
        className="mb-8"
      >
        <Link to="/containers" className="inline-flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors mb-4">
      ...
      <motion.div
        ...
        className="steel-panel p-5 mb-8"
      >
      ...
      >
        <div className="px-5 py-3 border-b border-border">
          <h2 className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground">Event Binders</h2>
        </div>
