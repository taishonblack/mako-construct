...
export function BinderCard({ binder }: { binder: MockBinder }) {
  return (
    <a
      ...
      className="group block steel-panel p-4 sm:p-5 hover:border-glow-red transition-all duration-300 w-full max-w-full overflow-hidden"
    >
      ...
      {/* Mobile summary: date + transport only */}
