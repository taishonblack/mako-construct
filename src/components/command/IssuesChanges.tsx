...
interface IssuesChangesProps {
  changes: ChangeEntry[];
  issues: Issue[];
}

export function IssuesChanges({ changes, issues }: IssuesChangesProps) {
  return (
    <motion.section
    ...
    >
      <h2 className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground mb-3">Issues & Pivots</h2>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        {/* Issues */}
        <div className="steel-panel p-5">
          <h3 className="text-[10px] tracking-wider uppercase text-muted-foreground mb-4">Active Issues</h3>
        ...
        {/* Changes */}
        <div className="steel-panel p-5">
          <h3 className="text-[10px] tracking-wider uppercase text-muted-foreground mb-4">Recent Changes</h3>
          <div className="relative">
            ...
            <div className="space-y-4">
              {changes.map((ch) => {
                ...
                return (
                  <div key={ch.id} className="relative flex items-start gap-3">
